...
private:
  ...
  public:
	...
	void removeIds(std::vector<int> &ids);
...
#define __min(x, y) ((x < y) ? x : y)
  ...
  public:
	...
	std::vector<std::pair<SimpleLine, PafColor>> getAllLinesWithColour(PafColor color);
	std::vector<std::pair<SimpleLine, PafColor>> getAllLinesWithColour(PafColor color, std::vector<int> &Ref_number_list);
